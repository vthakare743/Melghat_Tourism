...
<body>
    ...
    <asp:Label ID="Label1" runat="server" Text="Main Admin Login" Font-Bold="True" 
            Font-Names="Pristina" Font-Size="XX-Large" ForeColor="#006600C"></asp:Label>
		<br />
		...
		<%--<input type="checkbox"><label class="check" for="checkbox">Keep me logged in</label>&nbsp;--%>
            ...
            <asp:Button ID="btnback" runat="server" Text="Back" ForeColor="#CC0000" OnClick="btnback_Click" />
    <asp:Button ID="btnLogin" runat="server" Text="Login" onclick="btnLogin_Click" ForeColor="#006600" />
